...
contract ATokenVault is ERC4626Upgradeable, OwnableUpgradeable, EIP712Upgradeable, ATokenVaultStorage, IATokenVault {
    ...
    /// @inheritdoc IATokenVault
    function depositWithSig(uint256 assets, address receiver, address depositor, EIP712Signature calldata sig)
        public
        override
        returns (uint256)
    {
    ...
    /// @inheritdoc IATokenVault
    function depositATokensWithSig(uint256 assets, address receiver, address depositor, EIP712Signature calldata sig)
        public
        override
        returns (uint256)
    {
    ...
    /// @inheritdoc IATokenVault
    function mintWithSig(uint256 shares, address receiver, address depositor, EIP712Signature calldata sig)
        public
        override
        returns (uint256)
    {
    ...
    /// @inheritdoc IATokenVault
    function mintWithATokensWithSig(uint256 shares, address receiver, address depositor, EIP712Signature calldata sig)
        public
        override
        returns (uint256)
    {
    ...
    /// @inheritdoc IATokenVault
    function withdrawWithSig(uint256 assets, address receiver, address owner, EIP712Signature calldata sig)
        public
        override
        returns (uint256)
    {
    ...
    /// @inheritdoc IATokenVault
    function withdrawATokensWithSig(uint256 assets, address receiver, address owner, EIP712Signature calldata sig)
        public
        override
        returns (uint256)
    {
    ...
    /// @inheritdoc IATokenVault
    function redeemWithSig(uint256 shares, address receiver, address owner, EIP712Signature calldata sig)
        public
        override
        returns (uint256)
    {
    ...
    /// @inheritdoc IATokenVault
    function redeemWithATokensWithSig(uint256 shares, address receiver, address owner, EIP712Signature calldata sig)
        public
        override
        returns (uint256)
    {
    ...
    function maxWithdraw(address owner) public view override(ERC4626Upgradeable, IATokenVault) returns (uint256) {
        ...
        return maxWithdrawable == 0
            ? 0
            : maxWithdrawable.min(_convertToAssets(balanceOf(owner), MathUpgradeable.Rounding.Down));
    }
    ...
    function maxRedeem(address owner) public view override(ERC4626Upgradeable, IATokenVault) returns (uint256) {
        ...
        return maxWithdrawable == 0
            ? 0
            : _convertToShares(maxWithdrawable, MathUpgradeable.Rounding.Down).min(balanceOf(owner));
    }
    ...
    function _handleDeposit(uint256 assets, address receiver, address depositor, bool asAToken)
        internal
        returns (uint256)
    {
    ...
    function _handleMint(uint256 shares, address receiver, address depositor, bool asAToken)
        internal
        returns (uint256)
    {
    ...
    function _handleWithdraw(uint256 assets, address receiver, address owner, address allowanceTarget, bool asAToken)
        internal
        returns (uint256)
    {
        _accrueYield();
    ...
    function _handleRedeem(uint256 shares, address receiver, address owner, address allowanceTarget, bool asAToken)
        internal
        returns (uint256)
    {
        _accrueYield();
